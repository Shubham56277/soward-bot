...
export const ANTINUKE_DEFAULT_THRESHOLDS: Record<AntiNukeAction, number> = {
  ...
  channelDelete: 0,
  channelUpdate: 0,
  emojiStickerCreate: 0,
  emojiStickerDelete: 0,
  emojiStickerUpdate: 0,
  soundboardCreate: 0,
  soundboardDelete: 0,
  soundboardUpdate: 0,
  everyoneHerePing: 0,
  ...
  memberRoleUpdate: 0,
  integrationUpdate: 0,
  autoModerationRuleCreate: 0,
  autoModerationRuleUpdate: 0,
  autoModerationRuleDelete: 0,
  guildScheduledEventCreate: 0,
  guildScheduledEventUpdate: 0,
  guildScheduledEventDelete: 0,
  webhookUpdate: 0,
  autoRecovery: 0,
  botAdd: 0,
  guildUpdate: 0,
